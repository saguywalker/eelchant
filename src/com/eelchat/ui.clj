  ...
  (apply
   ...
   (-> ctx
       (merge #:base{:title settings/app-name
                     :lang "en-US"
                     :description (str settings/app-name " The world's finest dicussion platform.")
                     :image "/img/logo.png"})
       (update :base/head (fn [head]
                            (concat [[:link {:rel "stylesheet" :href (css-path)}]
                                     ...
                                     [:link {:href "/favicon-32x32.png", :size "32x32", :type "image/png", :rel "icon"}]
                                     [:link {:href "/favicon-16x16.png", :size "16x16", :type "image/png", :rel "icon"}]
